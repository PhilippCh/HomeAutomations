...
using HomeAutomations.Apps.KitchenLight;
...
namespace HomeAutomations.Apps.ScheduledLights;
...
/*public class ScheduledLights : BaseAutomation<ScheduledLights, ScheduledLightsConfig>
{
	...
	public ScheduledLights(MqttService mqttService, BaseAutomationDependencyAggregate<KitchenLight.KitchenLight, KitchenLightConfig> aggregate, NotificationService notificationService)
		: base(aggregate)
	{
