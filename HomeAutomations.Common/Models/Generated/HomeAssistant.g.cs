...
//   At: 2024-11-10T19:41:42.9121509+01:00
//
...
public static class GeneratedExtensions
{
    ...
    public static IServiceCollection AddHomeAssistantGenerated(this IServiceCollection serviceCollection)
    {
        ...
        serviceCollection.AddTransient<SeventeentrackServices>();
...
public partial class LightEntities
{
    ...
    ///<summary>living_room/lightstrip</summary>
    public LightEntity LivingRoomLightstrip => new(_haContext, "light.living_room_lightstrip");
...
public partial class MediaPlayerEntities
{
    ...
    ///<summary>RX-V4A 020D14 zone2</summary>
    public MediaPlayerEntity RxV4a020d14Zone2 => new(_haContext, "media_player.rx_v4a_020d14_zone2");
...
public partial class BinarySensorEntities
{
    ...
    ///<summary>bathroom/window_sensor Door</summary>
    ...
    ///<summary>bedroom/window_sensor Battery</summary>
    public BinarySensorEntity BedroomWindowSensorBatteryLow => new(_haContext, "binary_sensor.bedroom_window_sensor_battery_low");
    ///<summary>bedroom/window_sensor Door</summary>
    public BinarySensorEntity BedroomWindowSensorContact => new(_haContext, "binary_sensor.bedroom_window_sensor_contact");
    ...
    ///<summary>Internet status</summary>
    public BinarySensorEntity InternetAvailability => new(_haContext, "binary_sensor.internet_availability");
    ...
    ///<summary>kitchen/motion_detector Occupancy</summary>
    public BinarySensorEntity KitchenMotionDetectorOccupancy => new(_haContext, "binary_sensor.kitchen_motion_detector_occupancy");
    ///<summary>kitchen/neon_clock Fault</summary>
    public BinarySensorEntity KitchenNeonClockFault => new(_haContext, "binary_sensor.kitchen_neon_clock_fault");
    ...
    ///<summary>living_room/contract_light Fault</summary>
    public BinarySensorEntity LivingRoomContractLightFault => new(_haContext, "binary_sensor.living_room_contract_light_fault");
    ///<summary>living_room/lightbar Fault</summary>
    public BinarySensorEntity LivingRoomLightbarFault => new(_haContext, "binary_sensor.living_room_lightbar_fault");
    ///<summary>living_room/smoke_detector Device fault</summary>
    public BinarySensorEntity LivingRoomSmokeDetectorDeviceFault => new(_haContext, "binary_sensor.living_room_smoke_detector_device_fault");
    ///<summary>living_room/smoke_detector Smoke</summary>
    public BinarySensorEntity LivingRoomSmokeDetectorSmoke => new(_haContext, "binary_sensor.living_room_smoke_detector_smoke");
    ///<summary>living_room/smoke_detector Test</summary>
    public BinarySensorEntity LivingRoomSmokeDetectorTest => new(_haContext, "binary_sensor.living_room_smoke_detector_test");
    ///<summary>living_room/window_sensor_left Door</summary>
    public BinarySensorEntity LivingRoomWindowSensorLeftContact => new(_haContext, "binary_sensor.living_room_window_sensor_left_contact");
    ///<summary>living_room/window_sensor_right Door</summary>
    public BinarySensorEntity LivingRoomWindowSensorRightContact => new(_haContext, "binary_sensor.living_room_window_sensor_right_contact");
    ...
    ///<summary>Cat fountain light cycle state</summary>
    public BinarySensorEntity ScheduledLightsCatFountainState => new(_haContext, "binary_sensor.scheduled_lights_cat_fountain_state");
    ///<summary>Lava lamp light cycle state</summary>
    public BinarySensorEntity ScheduledLightsLavaLampState => new(_haContext, "binary_sensor.scheduled_lights_lava_lamp_state");
    ///<summary>Static lights light cycle state</summary>
    public BinarySensorEntity ScheduledLightsStaticLightsState => new(_haContext, "binary_sensor.scheduled_lights_static_lights_state");
    ///<summary>Trolley lights light cycle state</summary>
    public BinarySensorEntity ScheduledLightsTrolleyLightsState => new(_haContext, "binary_sensor.scheduled_lights_trolley_lights_state");
    ///<summary>study/smoke_detector Device fault</summary>
    public BinarySensorEntity StudySmokeDetectorDeviceFault => new(_haContext, "binary_sensor.study_smoke_detector_device_fault");
    ///<summary>study/smoke_detector Smoke</summary>
    public BinarySensorEntity StudySmokeDetectorSmoke => new(_haContext, "binary_sensor.study_smoke_detector_smoke");
    ///<summary>study/smoke_detector Test</summary>
    public BinarySensorEntity StudySmokeDetectorTest => new(_haContext, "binary_sensor.study_smoke_detector_test");
    ///<summary>study/speakers_philipp Fault</summary>
    public BinarySensorEntity StudySpeakersPhilippFault => new(_haContext, "binary_sensor.study_speakers_philipp_fault");
    ///<summary>study/window_sensor Door</summary>
    public BinarySensorEntity StudyWindowSensorContact => new(_haContext, "binary_sensor.study_window_sensor_contact");
...
public partial class ButtonEntities
{
    ...
    ///<summary>bedroom/laundry_day_button Identify</summary>
    public ButtonEntity BedroomLaundryDayButtonIdentify => new(_haContext, "button.bedroom_laundry_day_button_identify");
    ...
    ///<summary>HOME-DESKTOP-PH-satellite DesktopPhilipp_powershell_abort_shutdown</summary>
    public ButtonEntity HomeDesktopPhSatelliteDesktopphilippPowershellAbortShutdown => new(_haContext, "button.home_desktop_ph_satellite_desktopphilipp_powershell_abort_shutdown");
    ...
    ///<summary>kitchen/cabinet_light Identify</summary>
    public ButtonEntity KitchenCabinetLightIdentify => new(_haContext, "button.kitchen_cabinet_light_identify");
    ///<summary>kitchen/ceiling_light Identify</summary>
    public ButtonEntity KitchenCeilingLightIdentify => new(_haContext, "button.kitchen_ceiling_light_identify");
    ...
    ///<summary>living_room/lamp_switch Identify</summary>
    public ButtonEntity LivingRoomLampSwitchIdentify => new(_haContext, "button.living_room_lamp_switch_identify");
    ...
    ///<summary>study/unused_usb_relay_2 Restart</summary>
    public ButtonEntity StudyunusedUsbRelay2Restart => new(_haContext, "button.studyunused_usb_relay_2_restart");
...
public partial class ClimateEntities
{
    ...
    public ClimateEntity BathroomRadiatorThermostat => new(_haContext, "climate.bathroom_radiator_thermostat");
    ///<summary>Thermostat Schlafzimmer</summary>
    public ClimateEntity BedroomRadiatorThermostat => new(_haContext, "climate.bedroom_radiator_thermostat");
    ///<summary>bedroom/room_thermostat</summary>
    public ClimateEntity BedroomRoomThermostat => new(_haContext, "climate.bedroom_room_thermostat");
    ...
    public ClimateEntity StudyRadiatorThermostat => new(_haContext, "climate.study_radiator_thermostat");
}
...
public partial class InputBooleanEntities
{
    ...
    ///<summary>Intelligent Shopping List Active</summary>
    public InputBooleanEntity IntelligentShoppingListActive => new(_haContext, "input_boolean.intelligent_shopping_list_active");
    ///<summary>Intelligent shopping list dry run</summary>
    public InputBooleanEntity IntelligentShoppingListDryRun => new(_haContext, "input_boolean.intelligent_shopping_list_dry_run");
    ...
    ///<summary>netdaemon_home_automations_apps_alarms_alarms</summary>
    public InputBooleanEntity NetdaemonHomeAutomationsAppsAlarmsAlarms => new(_haContext, "input_boolean.netdaemon_home_automations_apps_alarms_alarms");
    ...
    ///<summary>netdaemon_home_automations_apps_heating_heating</summary>
    public InputBooleanEntity NetdaemonHomeAutomationsAppsHeatingHeating => new(_haContext, "input_boolean.netdaemon_home_automations_apps_heating_heating");
...
public partial class InputTextEntities
{
    ...
    ///<summary>Intelligent Shopping List Device Code</summary>
    public InputTextEntity IntelligentShoppingListDeviceCode => new(_haContext, "input_text.intelligent_shopping_list_device_code");
...
public partial class NumberEntities
{
    ...
    ///<summary>bathroom/radiator_thermostat Display brightness</summary>
    public NumberEntity BathroomRadiatorThermostatDisplayBrightness => new(_haContext, "number.bathroom_radiator_thermostat_display_brightness");
    ///<summary>bathroom/radiator_thermostat Display ontime</summary>
    public NumberEntity BathroomRadiatorThermostatDisplayOntime => new(_haContext, "number.bathroom_radiator_thermostat_display_ontime");
    ///<summary>bathroom/radiator_thermostat Temperature</summary>
    public NumberEntity BathroomRadiatorThermostatLocalTemperatureCalibration => new(_haContext, "number.bathroom_radiator_thermostat_local_temperature_calibration");
    ///<summary>bathroom/radiator_thermostat Remote temperature</summary>
    public NumberEntity BathroomRadiatorThermostatRemoteTemperature => new(_haContext, "number.bathroom_radiator_thermostat_remote_temperature");
    ///<summary>bedroom/lava_lamp Countdown</summary>
    public NumberEntity BedroomLavaLampCountdown => new(_haContext, "number.bedroom_lava_lamp_countdown");
    ///<summary>bedroom/radiator_thermostat Display brightness</summary>
    public NumberEntity BedroomRadiatorThermostatDisplayBrightness => new(_haContext, "number.bedroom_radiator_thermostat_display_brightness");
    ///<summary>bedroom/radiator_thermostat Display ontime</summary>
    public NumberEntity BedroomRadiatorThermostatDisplayOntime => new(_haContext, "number.bedroom_radiator_thermostat_display_ontime");
    ///<summary>bedroom/radiator_thermostat Temperature</summary>
    public NumberEntity BedroomRadiatorThermostatLocalTemperatureCalibration => new(_haContext, "number.bedroom_radiator_thermostat_local_temperature_calibration");
    ///<summary>bedroom/radiator_thermostat Remote temperature</summary>
    public NumberEntity BedroomRadiatorThermostatRemoteTemperature => new(_haContext, "number.bedroom_radiator_thermostat_remote_temperature");
    ///<summary>bedroom/room_thermostat Display brightness</summary>
    public NumberEntity BedroomRoomThermostatDisplayBrightness => new(_haContext, "number.bedroom_room_thermostat_display_brightness");
    ///<summary>bedroom/room_thermostat Display ontime</summary>
    public NumberEntity BedroomRoomThermostatDisplayOntime => new(_haContext, "number.bedroom_room_thermostat_display_ontime");
    ///<summary>bedroom/room_thermostat Temperature</summary>
    public NumberEntity BedroomRoomThermostatLocalTemperatureCalibration => new(_haContext, "number.bedroom_room_thermostat_local_temperature_calibration");
    ...
    ///<summary>kitchen/neon_clock Switch 1 Timer</summary>
    public NumberEntity KitchenNeonClockSwitch1Timer => new(_haContext, "number.kitchen_neon_clock_switch_1_timer");
    ...
    ///<summary>living_room/cat_fountain Countdown</summary>
    public NumberEntity LivingRoomCatFountainCountdown => new(_haContext, "number.living_room_cat_fountain_countdown");
    ///<summary>living_room/contract_light Switch 1 Timer</summary>
    public NumberEntity LivingRoomContractLightSwitch1Timer => new(_haContext, "number.living_room_contract_light_switch_1_timer");
    ///<summary>living_room/lightbar Switch 1 Timer</summary>
    public NumberEntity LivingRoomLightbarSwitch1Timer => new(_haContext, "number.living_room_lightbar_switch_1_timer");
    ///<summary>living_room/lightbulbs Countdown</summary>
    public NumberEntity LivingRoomLightbulbsCountdown => new(_haContext, "number.living_room_lightbulbs_countdown");
    ///<summary>living_room/radiator_thermostat Display brightness</summary>
    public NumberEntity LivingRoomRadiatorThermostatDisplayBrightness => new(_haContext, "number.living_room_radiator_thermostat_display_brightness");
    ///<summary>living_room/radiator_thermostat Display ontime</summary>
    public NumberEntity LivingRoomRadiatorThermostatDisplayOntime => new(_haContext, "number.living_room_radiator_thermostat_display_ontime");
    ///<summary>living_room/radiator_thermostat Temperature</summary>
    public NumberEntity LivingRoomRadiatorThermostatLocalTemperatureCalibration => new(_haContext, "number.living_room_radiator_thermostat_local_temperature_calibration");
    ///<summary>living_room/radiator_thermostat Remote temperature</summary>
    public NumberEntity LivingRoomRadiatorThermostatRemoteTemperature => new(_haContext, "number.living_room_radiator_thermostat_remote_temperature");
    ///<summary>living_room/record_player Countdown</summary>
    public NumberEntity LivingRoomRecordPlayerCountdown => new(_haContext, "number.living_room_record_player_countdown");
    ///<summary>living_room/subwoofer Countdown</summary>
    public NumberEntity LivingRoomSubwooferCountdown => new(_haContext, "number.living_room_subwoofer_countdown");
    ...
    ///<summary>study/desk_lamp Light 1 Timer</summary>
    public NumberEntity StudyDeskLampLight1Timer => new(_haContext, "number.study_desk_lamp_light_1_timer");
    ///<summary>study/radiator_thermostat Display brightness</summary>
    public NumberEntity StudyRadiatorThermostatDisplayBrightness => new(_haContext, "number.study_radiator_thermostat_display_brightness");
    ///<summary>study/radiator_thermostat Display ontime</summary>
    public NumberEntity StudyRadiatorThermostatDisplayOntime => new(_haContext, "number.study_radiator_thermostat_display_ontime");
    ///<summary>study/radiator_thermostat Temperature</summary>
    public NumberEntity StudyRadiatorThermostatLocalTemperatureCalibration => new(_haContext, "number.study_radiator_thermostat_local_temperature_calibration");
    ///<summary>study/radiator_thermostat Remote temperature</summary>
    public NumberEntity StudyRadiatorThermostatRemoteTemperature => new(_haContext, "number.study_radiator_thermostat_remote_temperature");
    ///<summary>study/speakers_philipp Switch 1 Timer</summary>
    public NumberEntity StudySpeakersPhilippSwitch1Timer => new(_haContext, "number.study_speakers_philipp_switch_1_timer");
...
public partial class SelectEntities
{
    ...
    ///<summary>bathroom/radiator_thermostat Display orientation</summary>
    public SelectEntity BathroomRadiatorThermostatDisplayOrientation => new(_haContext, "select.bathroom_radiator_thermostat_display_orientation");
    ///<summary>bathroom/radiator_thermostat Displayed temperature</summary>
    public SelectEntity BathroomRadiatorThermostatDisplayedTemperature => new(_haContext, "select.bathroom_radiator_thermostat_displayed_temperature");
    ///<summary>bathroom/radiator_thermostat Operating mode</summary>
    public SelectEntity BathroomRadiatorThermostatOperatingMode => new(_haContext, "select.bathroom_radiator_thermostat_operating_mode");
    ...
    ///<summary>bedroom/radiator_thermostat Display orientation</summary>
    public SelectEntity BedroomRadiatorThermostatDisplayOrientation => new(_haContext, "select.bedroom_radiator_thermostat_display_orientation");
    ///<summary>bedroom/radiator_thermostat Displayed temperature</summary>
    public SelectEntity BedroomRadiatorThermostatDisplayedTemperature => new(_haContext, "select.bedroom_radiator_thermostat_displayed_temperature");
    ///<summary>bedroom/radiator_thermostat Operating mode</summary>
    public SelectEntity BedroomRadiatorThermostatOperatingMode => new(_haContext, "select.bedroom_radiator_thermostat_operating_mode");
    ///<summary>bedroom/roller_shutter_left Motor speed</summary>
    public SelectEntity BedroomRollerShutterLeftMotorSpeed => new(_haContext, "select.bedroom_roller_shutter_left_motor_speed");
    ///<summary>bedroom/roller_shutter_right Motor speed</summary>
    public SelectEntity BedroomRollerShutterRightMotorSpeed => new(_haContext, "select.bedroom_roller_shutter_right_motor_speed");
    ///<summary>bedroom/room_thermostat Operating mode</summary>
    public SelectEntity BedroomRoomThermostatOperatingMode => new(_haContext, "select.bedroom_room_thermostat_operating_mode");
    ...
    ///<summary>living_room/lightstrip Color power on behavior</summary>
    public SelectEntity LivingRoomLightstripColorPowerOnBehavior => new(_haContext, "select.living_room_lightstrip_color_power_on_behavior");
    ///<summary>living_room/radiator_thermostat Display orientation</summary>
    public SelectEntity LivingRoomRadiatorThermostatDisplayOrientation => new(_haContext, "select.living_room_radiator_thermostat_display_orientation");
    ///<summary>living_room/radiator_thermostat Displayed temperature</summary>
    public SelectEntity LivingRoomRadiatorThermostatDisplayedTemperature => new(_haContext, "select.living_room_radiator_thermostat_displayed_temperature");
    ///<summary>living_room/radiator_thermostat Operating mode</summary>
    public SelectEntity LivingRoomRadiatorThermostatOperatingMode => new(_haContext, "select.living_room_radiator_thermostat_operating_mode");
    ...
    ///<summary>Roborock S7 Pro Ultra Selected map</summary>
    public SelectEntity RoborockS7ProUltraSelectedMap => new(_haContext, "select.roborock_s7_pro_ultra_selected_map");
    ///<summary>Sleep Timer</summary>
    public SelectEntity SleepTimer => new(_haContext, "select.sleep_timer");
    ///<summary>study/radiator_thermostat Display orientation</summary>
    public SelectEntity StudyRadiatorThermostatDisplayOrientation => new(_haContext, "select.study_radiator_thermostat_display_orientation");
    ///<summary>study/radiator_thermostat Displayed temperature</summary>
    public SelectEntity StudyRadiatorThermostatDisplayedTemperature => new(_haContext, "select.study_radiator_thermostat_displayed_temperature");
    ///<summary>study/radiator_thermostat Operating mode</summary>
    public SelectEntity StudyRadiatorThermostatOperatingMode => new(_haContext, "select.study_radiator_thermostat_operating_mode");
    ///<summary>study/speakers_philipp Light Mode</summary>
    public SelectEntity StudySpeakersPhilippLightMode => new(_haContext, "select.study_speakers_philipp_light_mode");
    ///<summary>study/speakers_philipp Power-on behavior</summary>
    public SelectEntity StudySpeakersPhilippPowerOnBehavior => new(_haContext, "select.study_speakers_philipp_power_on_behavior");
...
public partial class SensorEntities
{
    ...
    ///<summary>bathroom/radiator_thermostat Setpoint change source</summary>
    public SensorEntity BathroomRadiatorThermostatSetpointChangeSource => new(_haContext, "sensor.bathroom_radiator_thermostat_setpoint_change_source");
    ///<summary>bathroom/radiator_thermostat Valve adapt status</summary>
    public SensorEntity BathroomRadiatorThermostatValveAdaptStatus => new(_haContext, "sensor.bathroom_radiator_thermostat_valve_adapt_status");
    ...
    ///<summary>bedroom/radiator_thermostat Setpoint change source</summary>
    public SensorEntity BedroomRadiatorThermostatSetpointChangeSource => new(_haContext, "sensor.bedroom_radiator_thermostat_setpoint_change_source");
    ///<summary>bedroom/radiator_thermostat Valve adapt status</summary>
    public SensorEntity BedroomRadiatorThermostatValveAdaptStatus => new(_haContext, "sensor.bedroom_radiator_thermostat_valve_adapt_status");
    ...
    ///<summary>bedroom/window_sensor Action</summary>
    public SensorEntity BedroomWindowSensorAction => new(_haContext, "sensor.bedroom_window_sensor_action");
    ...
    ///<summary>FantenPhone App Version</summary>
    public SensorEntity FantenphoneAppVersion => new(_haContext, "sensor.fantenphone_app_version");
    ///<summary>FantenPhone Location permission</summary>
    public SensorEntity FantenphoneLocationPermission => new(_haContext, "sensor.fantenphone_location_permission");
    ///<summary>FantenPhone Watch Battery State</summary>
    public SensorEntity FantenphoneWatchBatteryState => new(_haContext, "sensor.fantenphone_watch_battery_state");
    ...
    ///<summary>HOME-DESKTOP-PH-satellite HOME-DESKTOP-PH-satellite_lastsystemstatechange</summary>
    public SensorEntity HomeDesktopPhSatelliteHomeDesktopPhSatelliteLastsystemstatechange => new(_haContext, "sensor.home_desktop_ph_satellite_home_desktop_ph_satellite_lastsystemstatechange");
    ...
    ///<summary>iPhone Philipp App Version</summary>
    public SensorEntity IphonePhilippAppVersion => new(_haContext, "sensor.iphone_philipp_app_version");
    ...
    ///<summary>iPhone Philipp Location permission</summary>
    public SensorEntity IphonePhilippLocationPermission => new(_haContext, "sensor.iphone_philipp_location_permission");
    ...
    ///<summary>iPhone Philipp Watch Battery State</summary>
    public SensorEntity IphonePhilippWatchBatteryState => new(_haContext, "sensor.iphone_philipp_watch_battery_state");
    ...
    ///<summary>living_room/radiator_thermostat Setpoint change source</summary>
    public SensorEntity LivingRoomRadiatorThermostatSetpointChangeSource => new(_haContext, "sensor.living_room_radiator_thermostat_setpoint_change_source");
    ///<summary>living_room/radiator_thermostat Valve adapt status</summary>
    public SensorEntity LivingRoomRadiatorThermostatValveAdaptStatus => new(_haContext, "sensor.living_room_radiator_thermostat_valve_adapt_status");
    ...
    ///<summary>17Track Package 1Z14597W6808897066</summary>
    ...
    ///<summary>study/radiator_thermostat Setpoint change source</summary>
    public SensorEntity StudyRadiatorThermostatSetpointChangeSource => new(_haContext, "sensor.study_radiator_thermostat_setpoint_change_source");
    ///<summary>study/radiator_thermostat Valve adapt status</summary>
    public SensorEntity StudyRadiatorThermostatValveAdaptStatus => new(_haContext, "sensor.study_radiator_thermostat_valve_adapt_status");
    ...
    ///<summary>bathroom/radiator_thermostat Battery</summary>
    public NumericSensorEntity BathroomRadiatorThermostatBattery => new(_haContext, "sensor.bathroom_radiator_thermostat_battery");
    ///<summary>bathroom/radiator_thermostat PI heating demand</summary>
    public NumericSensorEntity BathroomRadiatorThermostatPiHeatingDemand => new(_haContext, "sensor.bathroom_radiator_thermostat_pi_heating_demand");
    ...
    ///<summary>bathroom/window_sensor Battery</summary>
    public NumericSensorEntity BathroomWindowSensorBattery => new(_haContext, "sensor.bathroom_window_sensor_battery");
    ///<summary>bathroom/window_sensor Temperature</summary>
    public NumericSensorEntity BathroomWindowSensorDeviceTemperature => new(_haContext, "sensor.bathroom_window_sensor_device_temperature");
    ...
    ///<summary>bedroom/radiator_thermostat Battery</summary>
    public NumericSensorEntity BedroomRadiatorThermostatBattery => new(_haContext, "sensor.bedroom_radiator_thermostat_battery");
    ///<summary>bedroom/radiator_thermostat PI heating demand</summary>
    public NumericSensorEntity BedroomRadiatorThermostatPiHeatingDemand => new(_haContext, "sensor.bedroom_radiator_thermostat_pi_heating_demand");
    ...
    ///<summary>bedroom/room_thermostat Battery</summary>
    public NumericSensorEntity BedroomRoomThermostatBattery => new(_haContext, "sensor.bedroom_room_thermostat_battery");
    ///<summary>bedroom/room_thermostat Humidity</summary>
    public NumericSensorEntity BedroomRoomThermostatHumidity => new(_haContext, "sensor.bedroom_room_thermostat_humidity");
    ...
    ///<summary>bedroom/window_sensor Battery</summary>
    public NumericSensorEntity BedroomWindowSensorBattery => new(_haContext, "sensor.bedroom_window_sensor_battery");
    ...
    ///<summary>FantenPhone Watch Battery</summary>
    public NumericSensorEntity FantenphoneWatchBattery => new(_haContext, "sensor.fantenphone_watch_battery");
    ...
    ///<summary>iPhone Philipp Watch Battery</summary>
    public NumericSensorEntity IphonePhilippWatchBattery => new(_haContext, "sensor.iphone_philipp_watch_battery");
    ...
    ///<summary>kitchen/neon_clock Current</summary>
    public NumericSensorEntity KitchenNeonClockCurrent2 => new(_haContext, "sensor.kitchen_neon_clock_current_2");
    ///<summary>kitchen/neon_clock Electricity</summary>
    public NumericSensorEntity KitchenNeonClockElectricity => new(_haContext, "sensor.kitchen_neon_clock_electricity");
    ///<summary>kitchen/neon_clock Power</summary>
    public NumericSensorEntity KitchenNeonClockPower => new(_haContext, "sensor.kitchen_neon_clock_power");
    ///<summary>kitchen/neon_clock Voltage</summary>
    public NumericSensorEntity KitchenNeonClockVoltage2 => new(_haContext, "sensor.kitchen_neon_clock_voltage_2");
    ...
    ///<summary>living_room/contract_light Current</summary>
    public NumericSensorEntity LivingRoomContractLightCurrent => new(_haContext, "sensor.living_room_contract_light_current");
    ///<summary>living_room/contract_light Electricity</summary>
    public NumericSensorEntity LivingRoomContractLightElectricity => new(_haContext, "sensor.living_room_contract_light_electricity");
    ///<summary>living_room/contract_light Power</summary>
    public NumericSensorEntity LivingRoomContractLightPower => new(_haContext, "sensor.living_room_contract_light_power");
    ///<summary>living_room/contract_light Voltage</summary>
    public NumericSensorEntity LivingRoomContractLightVoltage => new(_haContext, "sensor.living_room_contract_light_voltage");
    ///<summary>living_room/lightbar Current</summary>
    public NumericSensorEntity LivingRoomLightbarCurrent2 => new(_haContext, "sensor.living_room_lightbar_current_2");
    ///<summary>living_room/lightbar Electricity</summary>
    public NumericSensorEntity LivingRoomLightbarElectricity => new(_haContext, "sensor.living_room_lightbar_electricity");
    ///<summary>living_room/lightbar Power</summary>
    public NumericSensorEntity LivingRoomLightbarPower => new(_haContext, "sensor.living_room_lightbar_power");
    ///<summary>living_room/lightbar Voltage</summary>
    public NumericSensorEntity LivingRoomLightbarVoltage2 => new(_haContext, "sensor.living_room_lightbar_voltage_2");
    ...
    ///<summary>living_room/radiator_thermostat Battery</summary>
    public NumericSensorEntity LivingRoomRadiatorThermostatBattery => new(_haContext, "sensor.living_room_radiator_thermostat_battery");
    ///<summary>living_room/radiator_thermostat PI heating demand</summary>
    public NumericSensorEntity LivingRoomRadiatorThermostatPiHeatingDemand => new(_haContext, "sensor.living_room_radiator_thermostat_pi_heating_demand");
    ...
    ///<summary>living_room/smoke_detector Battery</summary>
    public NumericSensorEntity LivingRoomSmokeDetectorBattery => new(_haContext, "sensor.living_room_smoke_detector_battery");
    ///<summary>living_room/smoke_detector Smoke concentration</summary>
    public NumericSensorEntity LivingRoomSmokeDetectorSmokeConcentration => new(_haContext, "sensor.living_room_smoke_detector_smoke_concentration");
    ...
    ///<summary>living_room/window_sensor_left Battery</summary>
    public NumericSensorEntity LivingRoomWindowSensorLeftBattery => new(_haContext, "sensor.living_room_window_sensor_left_battery");
    ///<summary>living_room/window_sensor_left Temperature</summary>
    public NumericSensorEntity LivingRoomWindowSensorLeftDeviceTemperature => new(_haContext, "sensor.living_room_window_sensor_left_device_temperature");
    ///<summary>living_room/window_sensor_right Battery</summary>
    public NumericSensorEntity LivingRoomWindowSensorRightBattery => new(_haContext, "sensor.living_room_window_sensor_right_battery");
    ///<summary>living_room/window_sensor_right Temperature</summary>
    public NumericSensorEntity LivingRoomWindowSensorRightDeviceTemperature => new(_haContext, "sensor.living_room_window_sensor_right_device_temperature");
    ...
    ///<summary>study/radiator_thermostat Battery</summary>
    public NumericSensorEntity StudyRadiatorThermostatBattery => new(_haContext, "sensor.study_radiator_thermostat_battery");
    ///<summary>study/radiator_thermostat PI heating demand</summary>
    public NumericSensorEntity StudyRadiatorThermostatPiHeatingDemand => new(_haContext, "sensor.study_radiator_thermostat_pi_heating_demand");
    ///<summary>study/smoke_detector Battery</summary>
    public NumericSensorEntity StudySmokeDetectorBattery => new(_haContext, "sensor.study_smoke_detector_battery");
    ///<summary>study/smoke_detector Smoke concentration</summary>
    public NumericSensorEntity StudySmokeDetectorSmokeConcentration => new(_haContext, "sensor.study_smoke_detector_smoke_concentration");
    ///<summary>study/speakers_philipp Current</summary>
    public NumericSensorEntity StudySpeakersPhilippCurrent => new(_haContext, "sensor.study_speakers_philipp_current");
    ///<summary>study/speakers_philipp Electricity</summary>
    public NumericSensorEntity StudySpeakersPhilippElectricity => new(_haContext, "sensor.study_speakers_philipp_electricity");
    ///<summary>study/speakers_philipp Power</summary>
    public NumericSensorEntity StudySpeakersPhilippPower => new(_haContext, "sensor.study_speakers_philipp_power");
    ///<summary>study/speakers_philipp Voltage</summary>
    public NumericSensorEntity StudySpeakersPhilippVoltage => new(_haContext, "sensor.study_speakers_philipp_voltage");
    ///<summary>study/window_sensor Battery</summary>
    public NumericSensorEntity StudyWindowSensorBattery => new(_haContext, "sensor.study_window_sensor_battery");
    ///<summary>study/window_sensor Temperature</summary>
    public NumericSensorEntity StudyWindowSensorDeviceTemperature => new(_haContext, "sensor.study_window_sensor_device_temperature");
    ...
    ///<summary>study/unused_usb_relay_2 WiFi Status</summary>
    public NumericSensorEntity StudyunusedUsbRelay2WifiStatus => new(_haContext, "sensor.studyunused_usb_relay_2_wifi_status");
...
public partial class SwitchEntities
{
    ...
    ///<summary>bathroom/radiator_thermostat Boost heating</summary>
    public SwitchEntity BathroomRadiatorThermostatBoostHeating => new(_haContext, "switch.bathroom_radiator_thermostat_boost_heating");
    ///<summary>bathroom/radiator_thermostat Child lock</summary>
    public SwitchEntity BathroomRadiatorThermostatChildLock => new(_haContext, "switch.bathroom_radiator_thermostat_child_lock");
    ///<summary>bathroom/radiator_thermostat Trigger adaptation process</summary>
    public SwitchEntity BathroomRadiatorThermostatValveAdaptProcess => new(_haContext, "switch.bathroom_radiator_thermostat_valve_adapt_process");
    ///<summary>bathroom/radiator_thermostat Window detection</summary>
    public SwitchEntity BathroomRadiatorThermostatWindowDetection => new(_haContext, "switch.bathroom_radiator_thermostat_window_detection");
    ...
    ///<summary>bedroom/radiator_thermostat Boost heating</summary>
    public SwitchEntity BedroomRadiatorThermostatBoostHeating => new(_haContext, "switch.bedroom_radiator_thermostat_boost_heating");
    ///<summary>bedroom/radiator_thermostat Child lock</summary>
    public SwitchEntity BedroomRadiatorThermostatChildLock => new(_haContext, "switch.bedroom_radiator_thermostat_child_lock");
    ///<summary>bedroom/radiator_thermostat Trigger adaptation process</summary>
    public SwitchEntity BedroomRadiatorThermostatValveAdaptProcess => new(_haContext, "switch.bedroom_radiator_thermostat_valve_adapt_process");
    ///<summary>bedroom/radiator_thermostat Window detection</summary>
    public SwitchEntity BedroomRadiatorThermostatWindowDetection => new(_haContext, "switch.bedroom_radiator_thermostat_window_detection");
    ///<summary>bedroom/room_thermostat Boost heating</summary>
    public SwitchEntity BedroomRoomThermostatBoostHeating => new(_haContext, "switch.bedroom_room_thermostat_boost_heating");
    ///<summary>bedroom/room_thermostat Child lock</summary>
    public SwitchEntity BedroomRoomThermostatChildLock => new(_haContext, "switch.bedroom_room_thermostat_child_lock");
    ///<summary>bedroom/room_thermostat Window detection</summary>
    public SwitchEntity BedroomRoomThermostatWindowDetection => new(_haContext, "switch.bedroom_room_thermostat_window_detection");
    ...
    ///<summary>Intelligent shopping list sort in progress</summary>
    public SwitchEntity IntelligentShoppingListActive => new(_haContext, "switch.intelligent_shopping_list_active");
    ///<summary>Dry run</summary>
    public SwitchEntity IntelligentShoppingListDryRun => new(_haContext, "switch.intelligent_shopping_list_dry_run");
    ///<summary>kitchen/neon_clock Switch 1</summary>
    public SwitchEntity KitchenNeonClockSwitch1 => new(_haContext, "switch.kitchen_neon_clock_switch_1");
    ...
    ///<summary>living_room/contract_light Switch 1</summary>
    public SwitchEntity LivingRoomContractLightSwitch1 => new(_haContext, "switch.living_room_contract_light_switch_1");
    ///<summary>living_room/lightbar Switch 1</summary>
    public SwitchEntity LivingRoomLightbarSwitch1 => new(_haContext, "switch.living_room_lightbar_switch_1");
    ...
    ///<summary>living_room/lightstrip Do not disturb</summary>
    public SwitchEntity LivingRoomLightstripDoNotDisturb => new(_haContext, "switch.living_room_lightstrip_do_not_disturb");
    ...
    ///<summary>living_room/radiator_thermostat Boost heating</summary>
    public SwitchEntity LivingRoomRadiatorThermostatBoostHeating => new(_haContext, "switch.living_room_radiator_thermostat_boost_heating");
    ///<summary>living_room/radiator_thermostat Child lock</summary>
    public SwitchEntity LivingRoomRadiatorThermostatChildLock => new(_haContext, "switch.living_room_radiator_thermostat_child_lock");
    ///<summary>living_room/radiator_thermostat Trigger adaptation process</summary>
    public SwitchEntity LivingRoomRadiatorThermostatValveAdaptProcess => new(_haContext, "switch.living_room_radiator_thermostat_valve_adapt_process");
    ///<summary>living_room/radiator_thermostat Window detection</summary>
    public SwitchEntity LivingRoomRadiatorThermostatWindowDetection => new(_haContext, "switch.living_room_radiator_thermostat_window_detection");
    ...
    ///<summary>living_room/smoke_detector Silence</summary>
    public SwitchEntity LivingRoomSmokeDetectorSilence => new(_haContext, "switch.living_room_smoke_detector_silence");
    ...
    ///<summary>Schedule #2cdbb9</summary>
    public SwitchEntity Schedule2cdbb9 => new(_haContext, "switch.schedule_2cdbb9");
    ///<summary>Schedule #3b5dc8</summary>
    public SwitchEntity Schedule3b5dc8 => new(_haContext, "switch.schedule_3b5dc8");
    ///<summary>Schedule #3e8efe</summary>
    public SwitchEntity Schedule3e8efe => new(_haContext, "switch.schedule_3e8efe");
    ///<summary>Schedule #7a33cd</summary>
    public SwitchEntity Schedule7a33cd => new(_haContext, "switch.schedule_7a33cd");
    ///<summary>Schedule #95ad53</summary>
    public SwitchEntity Schedule95ad53 => new(_haContext, "switch.schedule_95ad53");
    ///<summary>Schedule #9f7c7e</summary>
    public SwitchEntity Schedule9f7c7e => new(_haContext, "switch.schedule_9f7c7e");
    ///<summary>Schedule #b94c59</summary>
    public SwitchEntity ScheduleB94c59 => new(_haContext, "switch.schedule_b94c59");
    ///<summary>study/radiator_thermostat Boost heating</summary>
    public SwitchEntity StudyRadiatorThermostatBoostHeating => new(_haContext, "switch.study_radiator_thermostat_boost_heating");
    ///<summary>study/radiator_thermostat Child lock</summary>
    public SwitchEntity StudyRadiatorThermostatChildLock => new(_haContext, "switch.study_radiator_thermostat_child_lock");
    ///<summary>study/radiator_thermostat Trigger adaptation process</summary>
    public SwitchEntity StudyRadiatorThermostatValveAdaptProcess => new(_haContext, "switch.study_radiator_thermostat_valve_adapt_process");
    ///<summary>study/radiator_thermostat Window detection</summary>
    public SwitchEntity StudyRadiatorThermostatWindowDetection => new(_haContext, "switch.study_radiator_thermostat_window_detection");
    ///<summary>study/smoke_detector Silence</summary>
    public SwitchEntity StudySmokeDetectorSilence => new(_haContext, "switch.study_smoke_detector_silence");
    ///<summary>study/speakers_philipp Child Lock</summary>
    public SwitchEntity StudySpeakersPhilippChildLock => new(_haContext, "switch.study_speakers_philipp_child_lock");
    ///<summary>study/speakers_philipp Overcharge</summary>
    public SwitchEntity StudySpeakersPhilippOvercharge => new(_haContext, "switch.study_speakers_philipp_overcharge");
    ///<summary>study/speakers_philipp Switch 1</summary>
    public SwitchEntity StudySpeakersPhilippSwitch1 => new(_haContext, "switch.study_speakers_philipp_switch_1");
    ///<summary>study/unused_usb_relay_2 USB Relay</summary>
    public SwitchEntity StudyunusedUsbRelay2UsbRelay => new(_haContext, "switch.studyunused_usb_relay_2_usb_relay");
...
public partial class UpdateEntities
{
    ...
    ///<summary>bathroom/radiator_thermostat</summary>
    public UpdateEntity BathroomRadiatorThermostat => new(_haContext, "update.bathroom_radiator_thermostat");
    ...
    ///<summary>bedroom/radiator_thermostat</summary>
    public UpdateEntity BedroomRadiatorThermostat => new(_haContext, "update.bedroom_radiator_thermostat");
    ///<summary>bedroom/roller_shutter_left</summary>
    ...
    ///<summary>bedroom/room_thermostat</summary>
    public UpdateEntity BedroomRoomThermostat => new(_haContext, "update.bedroom_room_thermostat");
    ...
    ///<summary>living_room/radiator_thermostat</summary>
    public UpdateEntity LivingRoomRadiatorThermostat => new(_haContext, "update.living_room_radiator_thermostat");
    ///<summary>living_room/record_player</summary>
    ...
    ///<summary>study/radiator_thermostat</summary>
    public UpdateEntity StudyRadiatorThermostat => new(_haContext, "update.study_radiator_thermostat");
}
...
public partial class ZoneEntities
{
    ...
    ///<summary>Work Fant</summary>
    public ZoneEntity WorkFant => new(_haContext, "zone.work_fant");
    ///<summary>Work Pup</summary>
    public ZoneEntity WorkPup => new(_haContext, "zone.work_pup");
}
...
public partial class TodoEntities
{
    ...
    ///<summary>Apotheke Philipp</summary>
    public TodoEntity ApothekePhilipp => new(_haContext, "todo.apotheke_philipp");
    ///<summary>Asialaden Philipp</summary>
    public TodoEntity AsialadenPhilipp => new(_haContext, "todo.asialaden_philipp");
    ///<summary>Bioladen Philipp</summary>
    public TodoEntity BioladenPhilipp => new(_haContext, "todo.bioladen_philipp");
    ///<summary>Dänisches Bettenlager Philipp</summary>
    public TodoEntity DanischesBettenlagerPhilipp => new(_haContext, "todo.danisches_bettenlager_philipp");
    ///<summary>Einkauf - Backen Philipp</summary>
    public TodoEntity EinkaufBackenTodoPhilipp => new(_haContext, "todo.einkauf_backen_todo_philipp");
    ///<summary>Einkauf - dm 🧴🫧 Philipp</summary>
    public TodoEntity EinkaufDmPhilipp => new(_haContext, "todo.einkauf_dm_philipp");
    ///<summary>Einkauf - Frühstück Philipp</summary>
    public TodoEntity EinkaufFruhstuckPhilipp => new(_haContext, "todo.einkauf_fruhstuck_philipp");
    ///<summary>Einkauf - Gemüse Philipp</summary>
    public TodoEntity EinkaufGemusePhilipp => new(_haContext, "todo.einkauf_gemuse_philipp");
    ///<summary>Einkauf - Getränke Philipp</summary>
    public TodoEntity EinkaufGetrankePhilipp => new(_haContext, "todo.einkauf_getranke_philipp");
    ///<summary>Einkauf - Kühlregal Philipp</summary>
    public TodoEntity EinkaufKuhlregalPhilipp => new(_haContext, "todo.einkauf_kuhlregal_philipp");
    ///<summary>Einkauf - Pasta &amp; Konserven Philipp</summary>
    public TodoEntity EinkaufPastaKonservenPhilipp => new(_haContext, "todo.einkauf_pasta_konserven_philipp");
    ///<summary>Einkauf - Sonstiges Philipp</summary>
    public TodoEntity EinkaufSonstigesPhilipp => new(_haContext, "todo.einkauf_sonstiges_philipp");
    ///<summary>Einkauf - Süßigkeiten (TODO) Philipp</summary>
    public TodoEntity EinkaufSussigkeitenTodoPhilipp => new(_haContext, "todo.einkauf_sussigkeiten_todo_philipp");
    ///<summary>Einkauf - Tiefkühl Philipp</summary>
    public TodoEntity EinkaufTiefkuhlPhilipp => new(_haContext, "todo.einkauf_tiefkuhl_philipp");
    ///<summary>Einkaufen 🛒 Philipp</summary>
    public TodoEntity EinkaufenPhilipp => new(_haContext, "todo.einkaufen_philipp");
    ///<summary>Frankreich Philipp</summary>
    public TodoEntity FrankreichPhilipp => new(_haContext, "todo.frankreich_philipp");
    ///<summary>Haushaltstag Philipp</summary>
    public TodoEntity HaushaltstagPhilipp => new(_haContext, "todo.haushaltstag_philipp");
    ///<summary>IKEA Philipp</summary>
    public TodoEntity IkeaPhilipp => new(_haContext, "todo.ikea_philipp");
    ///<summary>Katzenfutter Philipp</summary>
    public TodoEntity KatzenfutterPhilipp => new(_haContext, "todo.katzenfutter_philipp");
    ///<summary>London 🏴󠁧󠁢󠁥󠁮󠁧󠁿 Philipp</summary>
    public TodoEntity LondonPhilipp => new(_haContext, "todo.london_philipp");
    ///<summary>Online Philipp</summary>
    public TodoEntity OnlinePhilipp => new(_haContext, "todo.online_philipp");
    ///<summary>Pass- und Verrechnungsformen Philipp</summary>
    public TodoEntity PassUndVerrechnungsformenPhilipp => new(_haContext, "todo.pass_und_verrechnungsformen_philipp");
    ///<summary>🫒 Rom 🍕 Philipp</summary>
    public TodoEntity RomPhilipp => new(_haContext, "todo.rom_philipp");
...
public partial class TagEntities
{
    ...
    ///<summary>Tag 263ee6b3-183f-4162-ad7f-2212761337ba</summary>
    public TagEntity _263ee6b3183f4162Ad7f2212761337ba => new(_haContext, "tag.263ee6b3_183f_4162_ad7f_2212761337ba");
    ///<summary>Tag 475e71fd-cac4-4226-9023-33fe7d58cc07</summary>
    public TagEntity _475e71fdCac44226902333fe7d58cc07 => new(_haContext, "tag.475e71fd_cac4_4226_9023_33fe7d58cc07");
    ///<summary>Tag 9a379275-57b8-4a1e-ae76-a038c064b4c7</summary>
    public TagEntity _9a37927557b84a1eAe76A038c064b4c7 => new(_haContext, "tag.9a379275_57b8_4a1e_ae76_a038c064b4c7");
    ///<summary>Desktop Philipp</summary>
    public TagEntity DesktopPhilipp => new(_haContext, "tag.desktop_philipp");
    ///<summary>Tag fa185cfa-28bb-4069-843c-b03c2a604dbc</summary>
    public TagEntity Fa185cfa28bb4069843cB03c2a604dbc => new(_haContext, "tag.fa185cfa_28bb_4069_843c_b03c2a604dbc");
    ///<summary>Test</summary>
    public TagEntity Test => new(_haContext, "tag.test");
}
...
public partial record BinarySensorAttributes
{
    ...
    public object? MotorSpeed { get; init; }

    [JsonPropertyName("trigger_count")]
    public double? TriggerCount { get; init; }

    [JsonPropertyName("device_fault")]
    public bool? DeviceFault { get; init; }

    [JsonPropertyName("silence")]
    public object? Silence { get; init; }

    [JsonPropertyName("smoke")]
    public bool? Smoke { get; init; }

    [JsonPropertyName("smoke_concentration")]
    public double? SmokeConcentration { get; init; }

    [JsonPropertyName("test")]
    public bool? Test { get; init; }

    [JsonPropertyName("ac_status")]
    public bool? AcStatus { get; init; }

    [JsonPropertyName("action")]
    public object? Action { get; init; }

    [JsonPropertyName("battery_defect")]
    public bool? BatteryDefect { get; init; }
    ...
    [JsonPropertyName("trouble")]
    public bool? Trouble { get; init; }
...
public partial record ClimateAttributes
{
    ...
    public string? Boost { get; init; }

    [JsonPropertyName("boost_heating")]
    public string? BoostHeating { get; init; }
    ...
    [JsonPropertyName("display_ontime")]
    public double? DisplayOntime { get; init; }

    [JsonPropertyName("display_orientation")]
    public string? DisplayOrientation { get; init; }

    [JsonPropertyName("displayed_temperature")]
    public string? DisplayedTemperature { get; init; }
    ...
    [JsonPropertyName("local_temperature_calibration")]
    public double? LocalTemperatureCalibration { get; init; }
    ...
    [JsonPropertyName("pi_heating_demand")]
    public double? PiHeatingDemand { get; init; }

    [JsonPropertyName("remote_temperature")]
    public double? RemoteTemperature { get; init; }

    [JsonPropertyName("running_state")]
    public string? RunningState { get; init; }

    [JsonPropertyName("setpoint_change_source")]
    public string? SetpointChangeSource { get; init; }
    ...
    [JsonPropertyName("valve_adapt_process")]
    public bool? ValveAdaptProcess { get; init; }

    [JsonPropertyName("valve_adapt_status")]
    public string? ValveAdaptStatus { get; init; }

    [JsonPropertyName("window_detection")]
    public string? WindowDetection { get; init; }

    [JsonPropertyName("window_open")]
    public string? WindowOpen { get; init; }
    ...
    [JsonPropertyName("keypad_lockout")]
    public string? KeypadLockout { get; init; }

    [JsonPropertyName("occupied_cooling_setpoint")]
    public double? OccupiedCoolingSetpoint { get; init; }
...
public interface IServices
{
    ...
    SeventeentrackServices Seventeentrack { get; }
...
public partial class Services : IServices
{
    ...
    public SeventeentrackServices Seventeentrack => new(_haContext);
...
public partial class LocaltuyaServices
{
    ...
    ///<param name="dp">Target DP, Datapoint index eg: 1</param>
    ///<param name="value">New value to set or list of dp: value, If value is list target dp will be ignored eg: { &quot;1&quot;: True, &quot;2&quot;: True }</param>
    public void SetDp(string deviceId, object value, long? dp = null)
    {
...
public partial record LocaltuyaSetDpParameters
{
    ...
    ///<summary>Target DP, Datapoint index eg: 1</summary>
    [JsonPropertyName("dp")]
    public long? Dp { get; init; }

    ///<summary>New value to set or list of dp: value, If value is list target dp will be ignored eg: { &quot;1&quot;: True, &quot;2&quot;: True }</summary>
    [JsonPropertyName("value")]
...
public partial class NetdaemonServices
{
    ...
    public void ComputerSwitchesBoot()
    {
        _haContext.CallService("netdaemon", "computer_switches_boot", null);
    }

    public void ComputerSwitchesShutdown()
    {
        _haContext.CallService("netdaemon", "computer_switches_shutdown", null);
    }
    ...
    {
        _haContext.CallService("netdaemon", "start_training", null);
    }
}
...
public partial class RoborockServices
{
    ...
    ///<summary>Get the map and room information of your device.</summary>
    ///<param name="target">The target for this service call</param>
    public void GetMaps(ServiceTarget target)
    {
        _haContext.CallService("roborock", "get_maps", target);
    }
}
...
public partial class SeventeentrackServices
{
    private readonly IHaContext _haContext;
    public SeventeentrackServices(IHaContext haContext)
    {
        _haContext = haContext;
    }

    ///<summary>Archive a package</summary>
    public void ArchivePackage(SeventeentrackArchivePackageParameters data)
    {
        _haContext.CallService("seventeentrack", "archive_package", null, data);
    }

    ///<summary>Archive a package</summary>
    ///<param name="packageTrackingNumber">The package will be archived for the specified tracking number.</param>
    ///<param name="configEntryId">The package will be archived for the selected service.</param>
    public void ArchivePackage(string packageTrackingNumber, object configEntryId)
    {
        _haContext.CallService("seventeentrack", "archive_package", null, new SeventeentrackArchivePackageParameters { PackageTrackingNumber = packageTrackingNumber, ConfigEntryId = configEntryId });
    }

    ///<summary>Get packages from 17Track</summary>
    public void GetPackages(SeventeentrackGetPackagesParameters data)
    {
        _haContext.CallService("seventeentrack", "get_packages", null, data);
    }

    ///<summary>Get packages from 17Track</summary>
    ///<param name="packageState">Only return packages with the specified states. Returns all packages if not specified.</param>
    ///<param name="configEntryId">The packages will be retrieved for the selected service.</param>
    public void GetPackages(object configEntryId, object? packageState = null)
    {
        _haContext.CallService("seventeentrack", "get_packages", null, new SeventeentrackGetPackagesParameters { PackageState = packageState, ConfigEntryId = configEntryId });
    }
}

public partial record SeventeentrackArchivePackageParameters
{
    ///<summary>The package will be archived for the specified tracking number.</summary>
    [JsonPropertyName("package_tracking_number")]
    public string? PackageTrackingNumber { get; init; }

    ///<summary>The package will be archived for the selected service.</summary>
    [JsonPropertyName("config_entry_id")]
    public object? ConfigEntryId { get; init; }
}

public partial record SeventeentrackGetPackagesParameters
{
    ///<summary>Only return packages with the specified states. Returns all packages if not specified.</summary>
    [JsonPropertyName("package_state")]
    public object? PackageState { get; init; }

    ///<summary>The packages will be retrieved for the selected service.</summary>
    [JsonPropertyName("config_entry_id")]
    public object? ConfigEntryId { get; init; }
}
...
{
    ///<summary>Get the map and room information of your device.</summary>
    public static void GetMaps(this IVacuumEntityCore target)
    {
        target.CallService("get_maps");
    }

    ///<summary>Get the map and room information of your device.</summary>
    public static void GetMaps(this IEnumerable<IVacuumEntityCore> target)
    {
        target.CallService("get_maps");
    }
}
