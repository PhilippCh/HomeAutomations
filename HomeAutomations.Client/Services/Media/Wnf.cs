...
public class Wnf
{
	...
	public static void SubscribeWnf(ulong state, uint changestamp, WnfUserCallback callback, out IntPtr subscriptionId)
	{
		RtlSubscribeWnfStateChangeNotification(
			out subscriptionId, state, changestamp,
	...
	[DllImport("ntdll.dll")]
	private static extern int RtlUnsubscribeWnfStateChangeNotification(ref IntPtr Subscription);
	...
	public class SafeHGlobalBuffer : SafeBuffer
	{
		...
		public SafeHGlobalBuffer(byte[] data)
			: this(data.Length)
		{
